...
user function ExecAu103()
	...
	// INÍCIO: INCLUSÃO //
		...
		If (nOpc == 3 )
			...
			AAdd(aLinha, {"D1_COD"		,   "SERV0001"		,NIL})
			AAdd(aLinha, {"D1_QUANT"	,   50			,NIL})
			AAdd(aLinha, {"D1_VUNIT"	,   25   		,NIL})
			AAdd(aLinha, {"D1_TOTAL"	,   1250		,NIL})
			...
			AAdd(aLinha, {"D1_LOTECTL"	,   "0081      "		,NIL})
			aAdd(aLinha, {"D1_DTVALID" ,  DDataBase + 10, NIL})
