...
ADD OPTION aRotina TITLE 'Conhecimento' ACTION 'MsDocument("ZA0", ZA0->(RecNo()), 4)' OPERATION 10 ACCESS 0
...
oModel := MPFormModel():New('COMP011M', /*bPreValidacao*/, { |oMdl| COMP013POS( oMdl ) }, /*bCommit*/, /*bCancel*/ )
...
Return MsgYesNo("Continuar?", "PROCESSO")
