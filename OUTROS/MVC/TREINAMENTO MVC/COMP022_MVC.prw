...
If     nOperation == MODEL_OPERATION_INSERT
	...
	For nI := 1 To oModelZA2:Length()
		...
		If ZA0->( MsSeek( xFilial( 'ZA0' ) + oModel:GetModel('ZA2DETAIL'):GetValue( 'ZA2_AUTOR', nI ) ) )
			RecLock( 'ZA0', .F. )
			ZA0->ZA0_QTDMUS++
			MsUnlock()
		EndIf
...
ElseIf nOperation == MODEL_OPERATION_DELETE
	...
	For nI := 1 To oModelZA2:Length()
		...
		If ZA0->( MsSeek( xFilial( 'ZA0' ) + FwFldGet( 'ZA2_AUTOR', nI ) ) )
			RecLock( 'ZA0', .F. )
...
If nOperation == MODEL_OPERATION_INSERT .OR. nOperation == MODEL_OPERATION_UPDATE
	...
	For nI := 1 To oModelZA2:Length()
		...
		If oModelZA2:IsUpdated() .OR. oModelZA2:IsDeleted() .OR. oModelZA2:IsUpdated()
			...
			If ZA0->( MsSeek( xFilial( 'ZA0' ) + oModelZA2:GetValue( 'ZA2_AUTOR', nI, oModel ) ) )
