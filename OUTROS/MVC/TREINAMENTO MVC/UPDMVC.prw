...
For nI := 1 To Len( aSX3 )
	...
	If !SX3->( MsSeek( PadR( aSX3[nI][nPosCpo], nTamSeek ) ) )
...
For nI := 1 To Len( aSIX )
	...
	If !SIX->( MsSeek( aSIX[nI][1] + aSIX[nI][2] ) )
		RecLock( 'SIX', .T. )
		lDelInd := .F.
...
For nI := 1 To Len( aSX7 )
	...
	If !SX7->( MsSeek( PadR( aSX7[nI][1], nTamSeek ) + aSX7[nI][2] ) )
...
For nI := 1 To Len( aSXB )
	...
	If !Empty( aSXB[nI][1] )
		...
		If !SXB->( MsSeek( PadR( aSXB[nI][1], Len( SXB->XB_ALIAS ) ) + aSXB[nI][2] + aSXB[nI][3] + aSXB[nI][4] ) )
...
For nI := 1 To Len( aSX1 )
	...
	If !SX1->( MsSeek( PadR( aSX1[nI][1], nTam1 ) + PadR( aSX1[nI][2], nTam2 ) ) )
...
For nI := 1 To Len( aSX9 )
	...
	If !SX9->( MsSeek( PadR( aSX9[nI][3], nTamSeek ) + PadR( aSX9[nI][1], nTamSeek ) ) )
