...
user function GPEA240 () // PEGPEA240 o nome do fonte não pode ter o mesmo nome da função nos pontos em MVC.
...
cMsg := 'Chamada no Botão Cancelar (MODELCANCEL).' + CRLF + 'Deseja Realmente Sair ?'
       ...
       ElseIf cIdPonto == 'BUTTONBAR' // aqui voce adiciona os botoes
